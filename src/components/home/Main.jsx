...
const Main = () => {
	return (
		<div className="pt-24 mx-auto max-w-7xl px-4  sm:px-6 flex flex-col justify-center items-center h-full">
			...
			<div className="flex justify-center items-center w-[140px] h-[140px] rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-[2px] cursor-pointer gelatine mt-10">
			...
			<span className="flex justify-end items-start w-full space-x-4">
